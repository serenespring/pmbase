...
export declare const TYPE_SHAPE = "shape";
export declare const TYPE_SVG_TEXT = "svgText";
...
export declare type Shape = ShapeShape | SvgTextShape;
export declare type ShapeRender = (element: React.ReactElement, shape: Shape, frameInfo: Required<Info>) => React.ReactNode;
export {};
