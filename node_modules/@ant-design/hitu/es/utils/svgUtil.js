...
export var INFO_KEYS = Object.keys(DEFAULT_VALUES);
export function fillInfo(info) {
...
export function getTransitionValue(start, end, ptg, cubic) {
  var ptgY = ptg;

  if (cubic) {
    var instance = _construct(CubicBezier, _toConsumableArray(cubic));
