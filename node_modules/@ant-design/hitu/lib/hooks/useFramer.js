...
exports.default = useFramer;

var React = _interopRequireWildcard(require("react"));

var _svgUtil = require("../utils/svgUtil");
...
function useFramer(totalFrames, config) {
  ...
  function getFrameInfo(_ref) {
    ...
    if (!frames || !frames.length) {
      return (0, _svgUtil.fillInfo)(rest);
    }
    ...
    for (var i = 0; i < frames.length - 1; i += 1) {
      ...
      if (startFrame.frame <= frameRef.current && frameRef.current < endFrame.frame) {
        var startInfo = (0, _svgUtil.fillInfo)(startFrame, {
          frames: frames.slice(0, i)
        });
        var endInfo = (0, _svgUtil.fillInfo)(endFrame, {
        ...
        return {
          x: (0, _svgUtil.getTransitionValue)(startInfo.x, endInfo.x, ptg, cubic),
          y: (0, _svgUtil.getTransitionValue)(startInfo.y, endInfo.y, ptg, cubic),
          rotate: (0, _svgUtil.getTransitionValue)(startInfo.rotate, endInfo.rotate, ptg, cubic),
          scaleX: (0, _svgUtil.getTransitionValue)(startInfo.scaleX, endInfo.scaleX, ptg, cubic),
          scaleY: (0, _svgUtil.getTransitionValue)(startInfo.scaleY, endInfo.scaleY, ptg, cubic),
          originX: (0, _svgUtil.getTransitionValue)(startInfo.originX, endInfo.originX, ptg, cubic),
          originY: (0, _svgUtil.getTransitionValue)(startInfo.originY, endInfo.originY, ptg, cubic),
          opacity: (0, _svgUtil.getTransitionValue)(startInfo.opacity, endInfo.opacity, ptg, cubic),
          theme: endInfo.theme || startInfo.theme
        };
      }
    }

    return (0, _svgUtil.fillInfo)(frames[frames.length - 1], {
